...
include("dbconnect.php");
  ...
  if (isset($_POST['upload'])) {
  	...
  	$c = mysqli_real_escape_string($conn, $_POST['price']);
 

  	// image file directory
  	$target = "images/".basename($image);

  	$sql = "INSERT INTO food_tb (fname,bname,price,image) VALUES ('$a','$b','$c','$image')";
  	// execute query
...
<head>
<meta http-equiv="Content-Type"multipart/form-data content="text/html; charset=UTF-8">
	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Food</h2>
			</div>
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Foods</h4>
								...
								<div class="card-block">
									<form class="form" action="addfood.php" method="POST" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Food Name</label>
													<input type="text" id="" class="form-control" placeholder="Food Name" name="fname" autocomplete="off">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Brand Name</label>
													<input type="mail" id="" class="form-control" placeholder="Brand Name" name="bname" autocomplete="off">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Price" name="price" autocomplete="off">
													</div>
												</div>
