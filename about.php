	...
	<!-- ABOUT PANEL START -->
		<div class="about_panel">
			<div class="container">
				<div class="row">
					<div class="col-lg-5">
						<h1 class="abt_head">About <span>Trivor</span></h1>
						<p class="abt_para">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever.</p>
					</div>
					<div class="col-lg-7">
						<img src="images/abt_img.png" class="img-fluid img-opcty">
					</div>
				</div>
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6">
						...
						<p class="abt-sub-para">Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
